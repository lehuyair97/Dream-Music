...
public class getDataPlaylistSongsByKeyPlaylist extends AsyncTask<Void, Void, Void> {
    private String mNamePlaylist;
    String path;
    private CallBackListener.SongsCallBack callback;

    public getDataPlaylistSongsByKeyPlaylist(String Path,String namePlaylist, CallBackListener.SongsCallBack callback) {
        this.path = Path;
        this.mNamePlaylist = namePlaylist;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        DatabaseReference playlistRef = FirebaseDatabase.getInstance().getReference().child(path).child(mNamePlaylist).child("Songs");
